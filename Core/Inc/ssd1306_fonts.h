 ...
 * @brief ASCII 5x7 bitmap font (characters 0x20 – 0x7E).
 *
 * Each character is 5 bytes wide; each byte is a column of 8 pixels (LSB = top).
 * A 1-pixel column gap is added by the renderer, giving a 6-pixel character cell.
 */
...
/* 95 printable ASCII characters starting at space (0x20) */
...
#define SSD1306_FONT_CHAR_HEIGHT 7
